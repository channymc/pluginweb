...
public class SkinUtil {
    public static void setPlayerSkinUsingUrlOrName(String playerUuid, String value) throws MineSkinException, DataRequestException {
        SkinsRestorer skinsRestorerApi = ChannyAnhWEBCommon.getInstance().getSkinsRestorerApi();
        ...
        Optional<Player> player = ChannyAnhWEBVelocity.getPlugin().getProxyServer().getPlayer(UUID.fromString(playerUuid));
        if (player.isPresent()) {
