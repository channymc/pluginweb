...
import com.channyanh.channyanhweb.bukkit.utils.TpsUtil;
...
import com.channyanh.channyanhweb.common.data.WorldData;
...
public class ServerIntelReportTask implements Runnable {
    ...
    public void run() {
        ...
        serverIntelData.max_players = ChannyAnhWEBBukkit.getPlugin().getServer().getMaxPlayers();
        serverIntelData.online_players = ChannyAnhWEBBukkit.getPlugin().getServer().getOnlinePlayers().size();
        ...
        serverIntelData.motd = ChannyAnhWEBBukkit.getPlugin().getServer().getMotd();
        serverIntelData.server_version = ChannyAnhWEBBukkit.getPlugin().getServer().getVersion();
        serverIntelData.server_session_id = ChannyAnhWEBBukkit.getPlugin().serverSessionId;
        ...
        final List<World> worlds = ChannyAnhWEBBukkit.getPlugin().getServer().getWorlds();
        ...
        serverIntelData.server_id = ChannyAnhWEBBukkit.getPlugin().getApiServerId();
