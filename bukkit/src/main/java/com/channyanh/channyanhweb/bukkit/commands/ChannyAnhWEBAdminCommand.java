...
public class ChannyAnhWEBAdminCommand implements CommandExecutor {
    @Override
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String s, @NotNull String[] strings) {
        ...
        if (firstArg.equalsIgnoreCase("banwarden:sync")) {
            ...
            if (!ChannyAnhWEBBukkit.getPlugin().getIsBanWardenEnabled()) {
    ...
    private void usage(CommandSender sender) {
        sender.sendMessage(ChatColor.AQUA + "ChannyAnhWEB Admin Commands:");
        sender.sendMessage(ChatColor.GREEN + "/channyanhweb banwarden:sync");
        sender.sendMessage(ChatColor.GRAY + "   Sync bans from ban plugin to ChannyAnhWEB website.");
        sender.sendMessage(ChatColor.GREEN + "/channyanhweb help");
