package com.channyanh.channyanhweb.bukkit.log4j;

import com.channyanh.channyanhweb.bukkit.ChannyAnhWEBBukkit;
import com.channyanh.channyanhweb.common.utils.AnsiColor;
import com.channyanh.channyanhweb.common.utils.TimeUtil;
...
@Plugin(name = "ChannyAnhWEB-ConsoleChannel", category = "Core", elementType = "appender", printObject = true)
public class ConsoleAppender extends AbstractAppender {
    ...
    static {
        ...
        if (createLayoutMethod == null) {
            ChannyAnhWEBBukkit.getPlugin().getLogger().warning("Failed to reflectively find the Log4j createLayout method. The console appender is not going to function.");
            PATTERN_LAYOUT = null;
        } else {
            ...
            try {
                ...
                ChannyAnhWEBBukkit.getPlugin().getLogger().warning("Failed to reflectively invoke the Log4j createLayout method. The console appender is not going to function.");
            }
    ...
    public ConsoleAppender() {
        super("ChannyAnhWEB-ConsoleChannel", null, PATTERN_LAYOUT, false);
    ...
    public void append(LogEvent event) {
        final ChannyAnhWEBBukkit plugin = ChannyAnhWEBBukkit.getPlugin();
