package com.channyanh.channyanhweb.bukkit.hooks.placeholderapi;
...
public class ChannyAnhWEBPlaceholderExpansion extends PlaceholderExpansion {
    private final ChannyAnhWEBBukkit plugin;

    public ChannyAnhWEBPlaceholderExpansion(ChannyAnhWEBBukkit plugin) {
        this.plugin = plugin;
    }
